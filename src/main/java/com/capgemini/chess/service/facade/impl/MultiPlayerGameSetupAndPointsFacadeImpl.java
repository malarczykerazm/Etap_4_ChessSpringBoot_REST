...
public class MultiPlayerGameSetupAndPointsFacadeImpl implements MultiPlayerGameSetupAndPointsFacade {
	...
	@Override
	public ChallengeTO initNewChallenge(ProfileTO sender, ProfileTO receiver) throws ChallengeValidationException {
		return challengeInitiation.init(sender, receiver);
	}

	@Override
	public List<ChallengeTO> findAwaitingChallenges(ProfileTO searcher) {
		return challengesSearch.findAwaitingChallenges(searcher);
	}
