...
/**
 * The class allows a player to find 5 potential oppenents within an assumed
 * level range, initiate a new challenge with a chosen user, find challenges of
 * a user that are awaiting and check a chosen user's profile.
 * 
 * @author EMALARCZ
 *
 */
public interface MultiPlayerGameSetupAndPointsFacade {
	 ...
	 * @param receiver
	 *            Profile Transfer Object of the receiver.
	 ...
	 */
	ChallengeTO initNewChallenge(ProfileTO sender, ProfileTO receiver) throws ChallengeValidationException;
